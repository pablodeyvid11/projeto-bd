...
public class EventoController {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Eventos obtidos com sucesso"),
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Evento obtido com sucesso"),
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Organizador adicionado com sucesso"),
			@ApiResponse(responseCode = "400", description = "Dados inválidos"),
			@ApiResponse(responseCode = "500", description = "Erro interno do servidor") })
