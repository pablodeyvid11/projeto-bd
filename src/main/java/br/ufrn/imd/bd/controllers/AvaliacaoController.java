...
public class AvaliacaoController {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Avaliações obtidas com sucesso"),
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Média de avaliações obtida com sucesso"),
			@ApiResponse(responseCode = "404", description = "Evento não encontrado") })
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Avaliação obtida com sucesso"),
	...
	public ResponseEntity<?> getAvaliacaoByEventoIdAndFesteiroId(@PathVariable Long eventoId,
			@PathVariable Long festeiroId, HttpServletRequest request) {
		try {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "201", description = "Avaliação criada com sucesso"),
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Avaliação atualizada com sucesso"),
			@ApiResponse(responseCode = "404", description = "Avaliação não encontrada"),
			@ApiResponse(responseCode = "400", description = "Dados inválidos") })
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Avaliação deletada com sucesso"),
			@ApiResponse(responseCode = "404", description = "Avaliação não encontrada") })
